...
for eachTestIm in testIm: 
    ...
    if (indexTrain/100 == j/10):
        ...
        if numWrong < 6.0: 
            ...
            imsave("./failureCases/" + "part3_" + str(int(numWrong))+ "_" +  'testFace.png', eachTestIm.reshape(train1Shape))

            # Print out the training face 
            imsave("./failureCases/" + "part3_" + str(int(numWrong)) + "_" +  'trainFace.png', trainIm[indexTrain].reshape(train1Shape))

            # Print out the eigenTestFace
            imsave("./failureCases/" + "part3_" + str(int(numWrong)) + "_"  +'eigenTestFace.png', get_reconstruction(eigenFace[:k], eachTestIm, averageFace).reshape(train1Shape))

            # Print out the eigenTrainingFace 
            imsave("./failureCases/" + "part3_" + str(int(numWrong)) + "_"   +'eigenTrainFace.png', get_reconstruction(eigenFace[:k], trainIm[indexTrain], averageFace).reshape(train1Shape))
