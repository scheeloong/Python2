...
#TODO: Re-write most of these into functions!! and write everything else in a main block 
...
blue = inputImage[0:numRows/3, :] # should crop from blue here 
green = inputImage[numRows/3: 2*numRows/3, : ]
red = inputImage[2*numRows/3: , :] # should crop from red here for rows 
...
#--------------------------------------------------------
# Matching using NCC (Normalized Cross Correlation) 
#--------------------------------------------------------
        
        # Dot product is the greatest when the images are most equal to each other 
...
#--------------------------------------------------------
# Try to align red and blue next  
#--------------------------------------------------------
...
#------------------------------------------------------------
# Now Handle Offsetting for SSD Images 
# Start with Rows
#------------------------------------------------------------
...
#------------------------------------------------------------
# Still Handling Offsetting for SSD Images
# Now handle columns 
#------------------------------------------------------------
#------------------------------------------------------------
#Handle for SSD images
...
#-----------------------------------------------------------------------------------------------
#------------------------------------------------------------
# Now Handle Offsetting for NCC Images 
# Start with rows 
#------------------------------------------------------------
#--------------------------------------------------------------------------
# HANDLE NCC 
...
#------------------------------------------------------------
# Continue Handle Offsetting for NCC Images 
# Now handle columns 
#------------------------------------------------------------
#------------------------------------------------------------
#Handle for SSD images
